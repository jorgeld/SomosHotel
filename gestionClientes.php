          ...
          <div class="container-fluid">
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <legend>Inserción de Cliente</legend>
                    <form method="POST" action="insercionClientes.php">
                        <table>
                            <tr>
                                <td>Nombre:</td>
                            ...
                            <tr>
                                <td>Apellidos:</td>
                                <td><input type="text" class="form-control" name="Apellidos" placeholder="Apellidos"></td>
                            </tr>
                            <tr>
                                <td>Dirección</td>
                            ...
                            <tr>
                                <td>DNI / Pasaporte</td>
                                <td><input type="text" class="form-control" name="dni" placeholder="Dirección"></td>
                            </tr>
                            <tr>
                                <td>Email</td>
                            ...
                            <tr>
                                <td>Telefono</td>
                                <td><input type="text" class="form-control" name="Telefono" placeholder="Telefono"></td>
                            </tr>
                            <tr>
                                <td>Movil</td>
                                <td><input type="text" class="form-control" name="Movil" placeholder="Movil"></td>
                            </tr>
                            <tr>
                                <td>Pais</td>
                                <td><select name="pais">
...
<option value="ZW">Zimbabue</option>
	...
	<option value='53'>Zaragoza</option>
                            ...
                            <tr>
                                <td>Ciudad</td>
                                <td><input type="text" class="form-control" name="Ciudad" placeholder="Ciudad"></td>
                            </tr> 
                            <tr>
                                <td>Código Postal:</td>
                                <td><input type="text" class="form-control" name="cp" placeholder="Código Postal"></td>
                            </tr> 
                        </table>

                       <button type="submit" class="btn btn-primary" id="insertarCliente">Insertar Cliente</button>
                    </form>
